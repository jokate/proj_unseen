...
public class LunarModularBase : ModuleRules
{
	public LunarModularBase(ReadOnlyTargetRules Target) : base(Target)
	{
        ...
        PublicDependencyModuleNames.AddRange(new string[] { "Core", "CoreUObject", "Engine", "InputCore", "UMG", "EnhancedInput", "OnlineSubsystem", "OnlineSubsystemUtils", "OnlineSubsystemSteam", "AIModule", "GameplayTasks" });
